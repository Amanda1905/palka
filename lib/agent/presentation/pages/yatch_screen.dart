...
class YatchScreen extends StatefulWidget {
  const YatchScreen({super.key});

  @override
  State<YatchScreen> createState() => YatchScreenState();
}

class YatchScreenState extends State<YatchScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Jasa Yatch', style: semibolddeepblueextStyle.copyWith(fontSize: 18)),
        centerTitle: true,
